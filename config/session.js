...
module.exports.session = {
  ...
  *                                                                          *
  ***************************************************************************/
  secret: 'b0b9d5ea9b4d6ed068c203c61e9c9669',
  ...
  ***************************************************************************/
  ...
  // url: 'mongodb://user:password@localhost:27017/urk-db', // user, password and port optional
  // url: 'mongodb://localhost:27017/urk-db', // user, password and port optional

  // adapter: 'mongo',
  // host: 'localhost',
  // port: 27017,
  // database: 'urk-db', //optional
  // url: 'mongodb://localhost:27017/urk-db',
